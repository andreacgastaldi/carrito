...
//const IMGBB_API_KEY = "https://andrea-gastaldi.imgbb.com/"; //👈reemplazan por la suya
const IMGBB_API_KEY = "1c94b4131a1b5b37e308e0718ebd6e43";
...
export const uploadToImgbb = async (file) => {
  ...
  if (json && json.data) {
    if (json.data.display_url) {
      ...
      console.log("URL de la imagen subida:1", json.data.display_url);
    }

    if (json.data.url) {
      return json.data.url;
      console.log("URL de la imagen subida:2", json.data.url);
    }
  }
